...
// Cross-platform helpers: recursive copy and remove using Node `fs`
...
function removeRecursiveSync(target) {
    ...
    if (typeof fs.rmSync === 'function') {
        try {
            ...
            // fall through to rmdirSync fallback
        }
    }
    if (typeof fs.rmdirSync === 'function') {
        try {
            ...
            // last resort: try manual deletion
        }
    }
